...
git config --global user.name "houdunwang"
```

设置默认使用的文本编辑器，下面是定义为sublime（不建议做这个配置项）
...
4. 应用更早的暂存 `git stash apply stash@{2} `
5. 删除暂存 `git stash drop stash@{0}`
...
![1526214082941](Git.assets/1526214082941.png)

![1526214156985](Git.assets/1526214156985.png)
...
![1526219105062](Git.assets/1526219105062.png)
...
![1526276371437](Git.assets/1526276371437.png)
...
下面示例我使用的是 `宝塔` 主机面板。 ![1526280838031](Git.assets/1526280838031.png)
...
![1526281914667](Git.assets/1526281914667.png)
